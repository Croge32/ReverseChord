...
public class DynamicListView extends ListView {
    ...
    public ArrayList<ChordsInSong> mChordList;
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) {
        ...
        for (int i=0; i<mCheeseList.size(); i++) {
        	System.out.println(mCheeseList.get(i)+" string at index "+i);
        }
        
        swapChords(mChordList, indexOne, indexTwo);
    }
    
    private void swapChords(ArrayList arrayList, int indexOne, int indexTwo) {
        Object temp = arrayList.get(indexOne);
        arrayList.set(indexOne, arrayList.get(indexTwo));
        arrayList.set(indexTwo, temp);
        
        for (int i=0; i<mChordList.size(); i++) {
        	System.out.println(mChordList.get(i).getOrder()+" order at index "+i);
        }
    }
    ...
    public void setChordListChord(ArrayList<ChordsInSong> chordList) {
